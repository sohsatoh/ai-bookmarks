        ...
        <article className="bg-white dark:bg-gray-900 rounded-2xl p-8 sm:p-12 shadow-sm">
          ...
          <div className="prose prose-gray dark:prose-invert max-w-none space-y-6">
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              この利用規約（以下「本規約」といいます。）は、AI
              Bookmarks（以下「本サービス」といいます。）がこのウェブサイト上で提供するサービスの利用条件を定めるものです。登録ユーザーの皆さま（以下「ユーザー」といいます。）には、本規約に従って、本サービスをご利用いただきます。
            </p>
            ...
            <section>
              ...
              <ol className="list-decimal list-inside space-y-2 text-gray-700 dark:text-gray-300 pl-4">
                <li>
                  本サービスにおいては、利用希望者が本規約に同意の上、本サービスの定める方法によって利用を開始し、本サービスがこれを承認することによって、利用登録が完了するものとします。
                </li>
                <li>
            ...
            <section>
              ...
              <ol className="list-decimal list-inside space-y-2 text-gray-700 dark:text-gray-300 pl-4">
                <li>
                  ユーザーは、自己の責任において、本サービスの利用に関するアカウント情報を適切に管理するものとします。
                </li>
                <li>
                  ユーザーは、いかなる場合にも、アカウント情報を第三者に譲渡または貸与し、もしくは第三者と共用することはできません。本サービスは、アカウント情報が登録情報と一致してログインされた場合には、そのアカウントを登録しているユーザー自身による利用とみなします。
                </li>
                <li>
                  アカウント情報が第三者によって使用されたことによって生じた損害は、本サービスに故意又は重大な過失がある場合を除き、本サービスは一切の責任を負わないものとします。
                </li>
              </ol>
            </section>
            ...
            <section>
              ...
              <ol className="list-decimal list-inside space-y-2 text-gray-700 dark:text-gray-300 pl-4">
                ...
                <li>
                  将来的に有料サービスを提供する場合、ユーザーは、本サービスの有料部分の対価として、本サービスが別途定め、本ウェブサイトに表示する利用料金を、本サービスが指定する方法により支払うものとします。
                </li>
                <li>
            ...
            <section>
              ...
              <ol className="list-decimal list-inside space-y-2 text-gray-700 dark:text-gray-300 pl-4">
                ...
                <li>
                  本サービスに関して紛争が生じた場合には、本サービスの所在地を管轄する裁判所を専属的合意管轄とします。
                </li>
              </ol>
            </section>
